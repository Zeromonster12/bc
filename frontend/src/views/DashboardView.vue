    ...
    <div class="space-y-8 overflow-x-hidden">
      ...
      <template v-if="auth.isStudent">
        ...
        <section class="overflow-x-hidden">
          ...
          <div v-if="projectStore.loading" class="flex w-full max-w-full gap-3 overflow-hidden">
            <div
              v-for="n in 4"
              :key="n"
          ...
          <div
            ...
            class="flex w-full max-w-full gap-3 overflow-x-auto overscroll-x-contain scroll-smooth pb-1"
          >
            <article
