<template>
  <div class="space-y-4">
    <div class="overflow-hidden rounded-xl border border-gray-200 bg-white dark:border-slate-700/70 dark:bg-slate-900/90">
      ...
      <table v-else class="w-full text-sm">
        ...
        <tbody class="divide-y divide-gray-100 dark:divide-slate-700/60">
          <tr v-if="projects.length === 0">
            <td colspan="5" class="px-4 py-10 text-center text-gray-400 dark:text-slate-500">No projects found.</td>
          </tr>
